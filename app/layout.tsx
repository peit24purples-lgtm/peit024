...
export const metadata: Metadata = {
  ...
  keywords: '정치테스트, 정치유형테스트, 정치 성향테스트 모음, 정치테스트 모음, 정치성향테스트, PEIT24, 정치mbti, 진보보수차이, 좌파우파차이, 나의정치성향, 정치성향알아보기, 경제성향테스트, 폴리티컬컴퍼스, 정치좌표테스트, 정치잘모르는데, 나는진보일까보수일까, 나랑맞는정당, 투표전테스트, 재미있는정치테스트, 정치처음, 정치색깔, 성향테스트, 정치유형, 좌파우파뜻, 진보뜻, 보수뜻, 정치스펙트럼, 정치이념, 중도성향, 정치입문, 청년정치, 친구랑할테스트, 심심풀이테스트, mbti말고, 나만 몰랐던 정치 성향, MBTI별 정치 성향, 20대 정치 성향 테스트, 커플 정치 성향 테스트, 신개념 정치 성향 테스트',
